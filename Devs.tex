...
\kw{end Y}
\dext{}((caudalObjetivo, caudalReal, fase, \cmlsigma{}, t\_desvio, t\_bolsa), e, (puerto, valor)) \kw{is}
    \kw{defcases}
        ...
        caudalReal = valor; t\_desvio = 5.0; \cmlsigma{} = min(\cmlsigma{} - e, t\_desvio);
            \kw{if} (puerto = sensorFlujo \cmlwedge{} abs(valor - caudalObjetivo) \cmlgt{} 0.1 * caudalObjetivo)
        caudalReal = valor; t\_desvio = infinity; \cmlsigma{} = \cmlsigma{} - e;
            \kw{if} (puerto = sensorFlujo \cmlwedge{} abs(valor - caudalObjetivo) \cmleq{} 0.1 * caudalObjetivo)
...
\clambda{}(caudalObjetivo, caudalReal, fase, \cmlsigma{}, t\_desvio, t\_bolsa) \kw{is}
    \kw{defcases}
        ...
        alarma = critica; detenerBomba = present;
            \kw{if} (fase = ALARMA\_CRITICA)
        detenerBomba = present;
